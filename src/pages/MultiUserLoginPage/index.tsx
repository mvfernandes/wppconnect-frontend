...
export function MultiUserLoginPage({history}) {
    ...
    useEffect(() => {
        ...
        api.post('mySession/THISISMYSECURETOKEN/generate-token')
            .then(response => {
    ...
    function insertLocalStorage() {
        login(JSON.stringify({session: session, token: token, user}));
    }
                                    ...
                                    qrCode !== "" ? null : (
                                        <Formulario onSubmit={(e) => submitSession(e)}>
                                           ...
                                           <select onChange={changeUser}>
                                            ...
                                            <button type="submit" id="send-btn" disabled={!user}>
                                                Enviar
                                            </button>
                                        </Formulario>
                                    )
